                        ...
                        <details className="mt-4 rounded-xl border border-theme-border bg-card p-3">
                            ...
                            <div className="mt-3 space-y-3">
                                <div>
                                    ...
                                    <pre className="mt-1 rounded-lg bg-theme-element px-3 py-2 text-[10px] font-mono text-theme-text whitespace-pre-wrap break-all leading-relaxed">{`[![Get it on Orion Store](https://raw.githubusercontent.com/RookieEnough/Orion-Store/refs/heads/main/assets/orion-badge.png)](https://rookieenough.github.io/Orion-Store/redirect.html?id=${encodeURIComponent(formData.id)})`}</pre>
                                    <button
                                        onClick={() => {
                                            navigator.clipboard.writeText(`[![Get it on Orion Store](https://raw.githubusercontent.com/RookieEnough/Orion-Store/refs/heads/main/assets/orion-badge.png)](https://rookieenough.github.io/Orion-Store/redirect.html?id=${encodeURIComponent(formData.id)})`);
                                        }}
